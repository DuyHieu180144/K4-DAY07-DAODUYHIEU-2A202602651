...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # No semantic separator remains: character slicing is the safe fallback.
        ...
        # Keep the separator with each preceding part so sentence/paragraph
        # boundaries are retained when chunks are later joined.
        ...
        for part in parts:
            ...
            if len(part) > self.chunk_size:
                smaller_parts.extend(self._split(part, remaining_separators[1:]))
            else:
                smaller_parts.append(part)

        # Merge adjacent small pieces; otherwise a text with many short lines
        # would create a large number of semantically weak tiny chunks.
        chunks: list[str] = []
        buffer = ""
